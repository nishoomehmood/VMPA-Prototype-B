...
import 'package:vpma_test_phase/screens/onboarding/screen_three.dart';

class OnboardingScreenTwo extends StatelessWidget {
  final PlayerController controller;
  OnboardingScreenTwo({super.key, required this.controller});
  @override
                ...
                RotatedBox(
                  ...
                  child: ClipPath(
                    ...
                    child: Container(
                      ...
                      color: Color.fromARGB(255, 82, 153, 114),
                    ),
                  ),
                ),
                Image(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Create your own  \nplaylist and personalize the app.',
                      textAlign: TextAlign.start,
                      style: TextStyle(
                        fontSize: 18,
                      ),
                    ...
                    child: FloatingActionButton(
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                OnboardingScreenThree(controller: controller),
                          ),
                        );
                      },
                      ...
                      child: const Icon(
                        ...
                        color: Color.fromARGB(255, 47, 110, 72),
                        size: 30,
                      ),
                    ),
                  )
